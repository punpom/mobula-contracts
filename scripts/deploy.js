...
async function main() {
  ...
  const StakingVault = await ethers.getContractFactory("MobulaStakingVault");
  const deployedStakingVault = await PrivateSale.deploy()
  ...
  await deployedStakingVault.deployed();
  console.log("Staking contract:", deployedStakingVault.address);
  console.log("Private Sale contract:", deployedPrivateSale.address);
